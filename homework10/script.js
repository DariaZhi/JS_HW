...
// как вернуть поле, которое является примером для заполнения todo:  
              //  <div class="island__item text-muted">
              //  Here I gonna...
              //  </div>

// новые задачи становятся в конец списка. Мне нужно, чтобы становились в начало. ОТВЕТ reversData = data.reverse  ( или в css задать reverse и изменить order)

// спросить у Леши, что сделать мне надо, чтобы мне подвечивало подсказки? Как-то подключиться через что-то?
